...
| `nested-static-wrapper-single-child.rdlc`, `nested-static-wrapper-multiple-children.rdlc`, `nested-static-detail-subtotal-sibling-branch.rdlc`, `nested-static-detail-subtotal-sibling-branch-no-header.rdlc`, `nested-static-detail-subtotal-sibling-branch-end-pagebreak.rdlc`, `nested-static-detail-subtotal-sibling-branch-start-end-pagebreak.rdlc`, `nested-static-detail-subtotal-sibling-branch-start-end-pagebreak-disabled.rdlc` | Single-child and multi-child static wrappers around nested groups, including nested static detail/subtotals followed by a sibling dynamic branch with optional root header, `End`/`StartAndEnd` page breaks, and parameter-disabled `StartAndEnd` behavior |
...
| `unsupported-static-sibling-boundary.rdlc`, `unsupported-static-leading-sibling-boundary.rdlc` | Explicit rejection of ambiguous top-level static sibling `KeepWithGroup` boundaries |
